...
#define WIFI_SPI_RST_PIN            ( B7 )                      // 定义复位引脚
...
#else   
#define WIFI_SPI_TARGET_IP          "192.168.181.87"              // 连接目标的 IP
//#define WIFI_SPI_TARGET_IP          "192.168.0.228"
#define WIFI_SPI_TARGET_PORT        "8080"                      // 连接目标的端口8080
